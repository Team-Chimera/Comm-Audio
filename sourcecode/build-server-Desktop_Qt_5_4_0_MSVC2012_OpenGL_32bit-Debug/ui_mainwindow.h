...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalSlider->setGeometry(QRect(20, 400, 831, 20));
        horizontalSlider->setAutoFillBackground(false);
        horizontalSlider->setOrientation(Qt::Horizontal);
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(400, 420, 93, 28));
        pushButton->setAutoFillBackground(false);
        horizontalSlider_2 = new QSlider(centralWidget);
        horizontalSlider_2->setObjectName(QStringLiteral("horizontalSlider_2"));
        horizontalSlider_2->setGeometry(QRect(650, 420, 160, 19));
        horizontalSlider_2->setOrientation(Qt::Horizontal);
        listView_2 = new QListView(centralWidget);
        listView_2->setObjectName(QStringLiteral("listView_2"));
        listView_2->setGeometry(QRect(680, 50, 211, 341));
        listView_2->setFrameShape(QFrame::WinPanel);
        songs = new QListWidget(centralWidget);
        songs->setObjectName(QStringLiteral("songs"));
        songs->setGeometry(QRect(10, 40, 591, 351));
        ...
        label_2->setGeometry(QRect(680, 25, 131, 21));
        QFont font1;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "Songs", 0));
        label_2->setText(QApplication::translate("MainWindow", "Connected", 0));
    } // retranslateUi
